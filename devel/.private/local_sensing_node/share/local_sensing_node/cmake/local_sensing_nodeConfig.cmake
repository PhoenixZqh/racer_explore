...
if("TRUE" STREQUAL "TRUE")
  set(local_sensing_node_SOURCE_PREFIX /root/jky/racer_explore/src/RACER/uav_simulator/local_sensing)
  set(local_sensing_node_DEVEL_PREFIX /root/jky/racer_explore/devel/.private/local_sensing_node)
  ...
  set(local_sensing_node_INSTALL_PREFIX /root/jky/racer_explore/install)
...
if(NOT "/usr/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'local_sensing_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/jky/racer_explore/src/RACER/uav_simulator/local_sensing/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/jky/racer_explore/devel/.private/local_sensing_node/lib;/root/jky/racer_explore/devel/lib;/opt/ros/noetic/lib)
