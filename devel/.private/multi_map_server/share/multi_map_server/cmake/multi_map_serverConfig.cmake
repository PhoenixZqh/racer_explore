...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /root/jky/racer_explore/src/RACER/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /root/jky/racer_explore/devel/.private/multi_map_server)
  ...
  set(multi_map_server_INSTALL_PREFIX /root/jky/racer_explore/install)
...
if(NOT "/root/jky/racer_explore/devel/.private/multi_map_server/include " STREQUAL " ")
  set(multi_map_server_INCLUDE_DIRS "")
  set(_include_dirs "/root/jky/racer_explore/devel/.private/multi_map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/jky/racer_explore/src/RACER/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/jky/racer_explore/devel/.private/multi_map_server/lib;/root/jky/racer_explore/devel/lib;/opt/ros/noetic/lib)
