...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_generator_SOURCE_PREFIX /root/jky/racer_explore/src/RACER/uav_simulator/Utils/waypoint_generator)
  set(waypoint_generator_DEVEL_PREFIX /root/jky/racer_explore/devel/.private/waypoint_generator)
  ...
  set(waypoint_generator_INSTALL_PREFIX /root/jky/racer_explore/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/jky/racer_explore/src/RACER/uav_simulator/Utils/waypoint_generator/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/jky/racer_explore/devel/.private/waypoint_generator/lib;/root/jky/racer_explore/devel/lib;/opt/ros/noetic/lib)
