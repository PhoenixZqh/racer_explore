...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /root/jky/racer_explore/src/RACER/uav_simulator/Utils/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /root/jky/racer_explore/devel/.private/rviz_plugins)
  ...
  set(rviz_plugins_INSTALL_PREFIX /root/jky/racer_explore/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/jky/racer_explore/src/RACER/uav_simulator/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/jky/racer_explore/devel/.private/rviz_plugins/lib;/root/jky/racer_explore/devel/lib;/opt/ros/noetic/lib)
